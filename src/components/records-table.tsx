...
import { AGENTS_BY_ID } from "@/lib/fixtures";
import type { Record as CanonicalRecord } from "@/lib/fixtures";

export function RecordsTable({ records }: { records: CanonicalRecord[] }) {
  return (
          ...
          >
            ...
            <div className="w-[110px] text-right tabular">
              <div className="text-[12.5px] text-ink-800 font-medium">
                {r.touches7d}
                <span className="text-muted font-normal"> / {r.budgetCap}</span>
              </div>
...
export function EmptyRecordsState({
  ...
  return (
    <Card className="p-12 text-center">
      <div className="mx-auto w-10 h-10 rounded-md bg-brand-50 text-brand flex items-center justify-center mb-3">
